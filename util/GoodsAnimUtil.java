...
//        mActivity = activity;
        ...
        ImageView buyImg = new ImageView(activity);
        // 设置buyImg的图片
        buyImg.setImageResource(R.drawable.oval_main);
        // 开始执行动画
        startAnim(buyImg, start_location1, activity);
    }
    /**
     *开始动画
     */
    private static void startAnim(final View v, int[] start_location, Activity activity) {
